    ...
    .post(
      ...
      },
      {
        body: t.Object({
          ...
          max_output_tokens_source: t.Optional(t.Union([t.Literal("auto"), t.Literal("api"), t.Literal("manual")])),
          think_opening_tag_mode: t.Optional(t.Union([t.Literal("off"), t.Literal("detect"), t.Literal("force")])),
